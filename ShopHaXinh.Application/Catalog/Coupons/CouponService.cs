...
namespace ShopHaXinh.Application.Catalog.Coupons
{
    public class CouponService : ICouponService
    {
        ...
        public CouponService(ShopHaXinhDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> Update(CouponUpdateRequest request)
        {
            ...
            if (coupon == null) throw new ShopHaXinhException($"Không thể tìm coupon có ID: {request.Id} ");
        ...
        public async Task<int> Delete(int couponId)
        {
            ...
            if (coupon == null) throw new ShopHaXinhException($"Không thể tìm coupon có ID: {coupon} ");
