...
using ShopHaXinh.Utilities.Exceptions;
...
namespace ShopHaXinh.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(ShopHaXinhDbContext context, IStorageService storageService, IConfiguration configuration,
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null) throw new ShopHaXinhException($"Không thể tìm sản phẩm có ID: {request.Id} ");
        ...
        public async Task<int> Delete(int productId)
        {
            ...
            if (product == null) throw new ShopHaXinhException($"Không thể tìm sản phẩm có ID: {productId}");
        ...
        public async Task<bool> DecreaseStock(int productId, int quantity)
        {
            ...
            if (product == null) throw new ShopHaXinhException($"Cannot find product with id: {productId} ");
