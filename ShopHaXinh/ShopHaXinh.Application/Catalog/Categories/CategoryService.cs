...
namespace ShopHaXinh.Application.Catalog.Categories
{
    public class CategoryService : ICategoryService
    {
        ...
        public CategoryService(ShopHaXinhDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> Update(CategoryUpdateRequest request)
        {
            ...
            if (category == null) throw new ShopHaXinhException($"Không thể tìm danh mục có ID: {request.Id} ");
        ...
        public async Task<int> Delete(int categoryId)
        {
            ...
            if (category == null) throw new ShopHaXinhException($"Không thể tìm danh mục có ID: {categoryId} ");
